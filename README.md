...
2. В папке /home/administrator/diplom запускаем по очереди скрипты **deploy-mysql-replication.sh** и **install_apache_php83.sh**
   ...
   Которые установят:
      ...
      2.3 Резервирование баз для последующего восстановления **backup_all_db.sh**
      2.4 Потабличное задание резервирования **backup_tables.sh**  
4. Установка nginx и настройка балансировки **install_nginx.sh**.  
    _Технически его можно установить на один из серверов с Apache, но лучше выделить под nginx небольшой отдельный сервер_
5. Установка zabbix-agent **install_zabbix_agent.sh**
6. Для подключения мониторинга Zabbix зайти на http://zbxsrv/zabbix и добавить станцию  
